        ...
        <>
            ...
            <div className="product">
                <div className="filter">
                    <ProductFilter  current={current} setCurrent={setCurrent} Function={props.GetRecommendFiltered} filter={props.filter?.data} GetFilter={props.GetFilter}/>
                </div>
                <div className="cards">
                    {line?itemLine:item}
                    <PaginationBlock Function={props.GetRecommends} current={current} setCurrent={setCurrent}  total={props.product?.pageCount}/>
                </div>
            </div>
