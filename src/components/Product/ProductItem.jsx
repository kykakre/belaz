    ...
    return (
        <div className={style.card}>
            <div className={style.contain}>
                <img src={props.img? "https://s.stats.cfd/"+props.img : props.img} className={style.productImg} alt="product"/>
            ...
            <div className={style.flex}>
                ...
                {props.rating === 0?<>
                    <img src={star} className={style.star} alt="grabe"/> <div>{props.rating} ({props.totalGrabe} оценок)</div>
                </> :<div>Нет оценок</div>}
