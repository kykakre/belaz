      ...
      <div className={style.container}>
        <div className={style.item}>
          ...
          <div className={style.text}>
            620102, город Екатеринбург, улица Посадская, 16а, корпус И,
            помещение И-101
          </div>
        ...
        <div className={style.itemLast}>
          ...
          <a href="https://wa.me/73432875732" className={style.phone}>
            +7 (343) 287-57-32
          </a>
          <a href="https://wa.me/79655327026" className={style.phone}>
            +7 (965) 532-70-26
          </a>
          <a href="https://wa.me/79222095332" className={style.phone}>
            +7 (922) 209-53-32
          </a>
